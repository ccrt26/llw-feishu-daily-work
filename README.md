...
飞书云文档的读取、导出和用户 OAuth 权限已经生效。当前 V4.4.3 生产链仍会把
DOCX 中普通网页 hyperlink 误判为危险 External 关系，因此真实阅读和入库尚未
完成验收。V4.4.4 隔离候选只修复这一安全分类，不增加权限、Agent、Writer 或
新主链；完成生产部署和真实飞书验收前，它仍不是当前已验收能力。普通上传文件
不受此遗留项影响。
